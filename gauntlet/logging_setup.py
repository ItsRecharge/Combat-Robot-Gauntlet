"""Central logging setup for Gauntlet.
...
Every module under ``gauntlet.*`` gets a namespaced logger via
:func:`get_logger` and **never** configures handlers itself. The application
entry point (:mod:`gauntlet.__main__`) calls :func:`configure_logging`
...
Gauntlet as a library never hijacks the host application's logging.
"""
...
def configure_logging(
    ...
    *,
    ...
    """Attach handlers to the ``gauntlet`` package-root logger.
